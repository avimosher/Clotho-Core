...
public class ClothoDocument extends Document {
  ...
  public Document append (String name) throws IOException {
    return new ClothoDocument (new File (getFile (), name));
  }
  ...
  public Document getParent () {
    try {
      ...
      return new ClothoDocument (new File (canonical_file.getParent ()));
    } catch (IOException e) {
      return null;
    }
  }
