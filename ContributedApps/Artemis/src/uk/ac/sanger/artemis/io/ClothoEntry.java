...
public class ClothoEntry implements Entry
{

  public ClothoEntry(final Part clothoPart)
                      
      throws IOException
  {
    this.clothoPart = clothoPart;
    this.entryInformation=new SimpleEntryInformation();
    featTable = new StreamFeatureTable ();

    //setArtemisFeatures(clothoPart);
    setArtemisSequence(clothoPart);
  }

  public ClothoEntry (final Entry old_entry) {
...
*/
  ...
  private void setArtemisSequence(final Part part) {
    artemisSequence = new ClothoSequence(part);
  }
